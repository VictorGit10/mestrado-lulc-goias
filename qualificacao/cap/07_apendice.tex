...
\begin{table}[!ht]
\centering
\caption[Sensibilidade do termo de vizinhança à matriz]{Termo de vizinhança do teste espacial com quatro, oito e doze vizinhos.}
\label{tab:slx-w}
\footnotesize
\begin{tabular}{lllccc}
\toprule
\textbf{Régua de lavoura} & \textbf{Desfecho} & \textbf{$W$} & \textbf{$k = 4$} & \textbf{$k = 8$} & \textbf{$k = 12$} \\
\midrule
\multicolumn{6}{l}{\textit{Janela plena (1985--2024)}} \\
Agricultura & $\Delta$ pastagem & $W_{\mathrm{sul}}$ & $-0{,}064$ ($0{,}294$) & $-0{,}157$ ($0{,}020$) & $-0{,}088$ ($0{,}414$) \\
Agricultura & $\Delta$ pastagem & $W_{\mathrm{norte}}$ (placebo) & $+0{,}072$ ($0{,}472$) & $+0{,}182$ ($0{,}203$) & $+0{,}115$ ($0{,}355$) \\
Agricultura & $\Delta$ bovinos & $W_{\mathrm{sul}}$ & $-0{,}051$ ($0{,}550$) & $-0{,}124$ ($0{,}261$) & $-0{,}028$ ($0{,}925$) \\
Agric. $\cup$ Mosaico & $\Delta$ pastagem & $W_{\mathrm{sul}}$ & $-0{,}100$ ($0{,}272$) & $-0{,}050$ ($0{,}545$) & $-0{,}044$ ($0{,}537$) \\
Agric. $\cup$ Mosaico & $\Delta$ pastagem & $W_{\mathrm{norte}}$ (placebo) & $+0{,}024$ ($0{,}459$) & $-0{,}017$ ($0{,}717$) & $-0{,}060$ ($0{,}294$) \\
Agric. $\cup$ Mosaico & $\Delta$ bovinos & $W_{\mathrm{sul}}$ & $-0{,}198$ ($0{,}259$) & $-0{,}018$ ($0{,}902$) & $+0{,}053$ ($0{,}839$) \\
Soja (SIDRA) & $\Delta$ pastagem & $W_{\mathrm{sul}}$ & $-0{,}015$ ($0{,}307$) & $-0{,}012$ ($0{,}526$) & $-0{,}007$ ($0{,}812$) \\
Soja (SIDRA) & $\Delta$ pastagem & $W_{\mathrm{norte}}$ (placebo) & $-0{,}033$ ($0{,}215$) & $-0{,}054$ ($0{,}032$) & $-0{,}077$ ($0{,}004$) \\
Soja (SIDRA) & $\Delta$ bovinos & $W_{\mathrm{sul}}$ & $+0{,}001$ ($0{,}976$) & $-0{,}024$ ($0{,}752$) & $+0{,}063$ ($0{,}743$) \\
\multicolumn{6}{l}{\textit{Janela truncada (1985--2019)}} \\
Agricultura & $\Delta$ pastagem & $W_{\mathrm{sul}}$ & $-0{,}050$ ($0{,}424$) & $-0{,}122$ ($0{,}083$) & $-0{,}115$ ($0{,}104$) \\
Agricultura & $\Delta$ pastagem & $W_{\mathrm{norte}}$ (placebo) & $+0{,}064$ ($0{,}449$) & $+0{,}141$ ($0{,}215$) & $+0{,}080$ ($0{,}424$) \\
Agricultura & $\Delta$ bovinos & $W_{\mathrm{sul}}$ & $-0{,}016$ ($0{,}864$) & $-0{,}096$ ($0{,}429$) & $-0{,}016$ ($0{,}957$) \\
Agric. $\cup$ Mosaico & $\Delta$ pastagem & $W_{\mathrm{sul}}$ & $-0{,}123$ ($0{,}239$) & $-0{,}075$ ($0{,}421$) & $-0{,}072$ ($0{,}360$) \\
Agric. $\cup$ Mosaico & $\Delta$ pastagem & $W_{\mathrm{norte}}$ (placebo) & $+0{,}039$ ($0{,}254$) & $-0{,}014$ ($0{,}805$) & $-0{,}067$ ($0{,}312$) \\
Agric. $\cup$ Mosaico & $\Delta$ bovinos & $W_{\mathrm{sul}}$ & $-0{,}192$ ($0{,}329$) & $-0{,}012$ ($0{,}941$) & $+0{,}093$ ($0{,}738$) \\
Soja (SIDRA) & $\Delta$ pastagem & $W_{\mathrm{sul}}$ & $-0{,}020$ ($0{,}038$) & $-0{,}025$ ($0{,}094$) & $-0{,}016$ ($0{,}501$) \\
Soja (SIDRA) & $\Delta$ pastagem & $W_{\mathrm{norte}}$ (placebo) & $-0{,}045$ ($0{,}114$) & $-0{,}053$ ($0{,}052$) & $-0{,}065$ ($0{,}022$) \\
Soja (SIDRA) & $\Delta$ bovinos & $W_{\mathrm{sul}}$ & $+0{,}021$ ($0{,}719$) & $-0{,}007$ ($0{,}934$) & $+0{,}080$ ($0{,}705$) \\
\bottomrule
\end{tabular}
\fontefig{elaboração própria, a partir de \texttt{scripts/\_sensibilidade\_w\_deslocamento.py}.}
\notafig{cada célula traz $\hat{\theta}$ e, entre parênteses, o $p$; mesma especificação da Tabela~\ref{tab:slx}, que corresponde à coluna $k = 8$. $k$ é o número de vizinhos mais próximos sobre o qual o filtro direcional é aplicado.}
\end{table}
...
\small
\begin{tabular}{p{3.0cm}p{1.8cm}ccccccr}
\toprule
\textbf{Exposição} & \textbf{Desfecho} & \textbf{Def.} & \textbf{Sinal} & \textbf{$\hat{\gamma}$} & \textbf{EP} & \textbf{$p$} & \textbf{$R^2_w$} & \textbf{$n$} \\
\midrule
Fronteira (veg. convertível, Norte) & $\Delta$ Rebanho & 0 & + & $+0{,}0147$ & $0{,}0138$ & $0{,}288$ & $0{,}00023$ & 6.474 \\
Fronteira (veg. convertível, Norte) & $\Delta$ Rebanho & 1 & + & $+0{,}0285$ & $0{,}0132$ & $0{,}031$ & $0{,}00089$ & 6.308 \\
Fronteira (veg. convertível, Norte) & $\Delta$ Pastagem & 0 & + & $-0{,}0111$ & $0{,}0355$ & $0{,}755$ & $0{,}00017$ & 6.474 \\
Fronteira (veg. convertível, Norte) & $\Delta$ Pastagem & 1 & + & $+0{,}0067$ & $0{,}0328$ & $0{,}838$ & $0{,}00007$ & 6.308 \\
Aptidão agrícola (Sul) & $\Delta$ Agricultura & 0 & + & $-0{,}0319$ & $0{,}0471$ & $0{,}498$ & $0{,}00175$ & 6.474 \\
Aptidão agrícola (Sul) & $\Delta$ Agricultura & 1 & + & $-0{,}0305$ & $0{,}0486$ & $0{,}530$ & $0{,}00149$ & 6.308 \\
Especialização em pasto & $\Delta$ Pastagem & 0 & - & $-0{,}0036$ & $0{,}0302$ & $0{,}906$ & $0{,}00002$ & 6.474 \\
Especialização em pasto & $\Delta$ Pastagem & 1 & - & $+0{,}0059$ & $0{,}0284$ & $0{,}835$ & $0{,}00005$ & 6.308 \\
Aptidão edafoclim. (exógena) & $\Delta$ Rebanho & 0 & - & $-0{,}0016$ & $0{,}0118$ & $0{,}890$ & $0{,}00000$ & 6.474 \\
Aptidão edafoclim. (exógena) & $\Delta$ Rebanho & 1 & - & $-0{,}0325$ & $0{,}0146$ & $0{,}026$ & $0{,}00116$ & 6.308 \\
Aptidão edafoclim. (exógena) & $\Delta$ Agricultura & 0 & + & $-0{,}0062$ & $0{,}0210$ & $0{,}770$ & $0{,}00006$ & 6.474 \\
Aptidão edafoclim. (exógena) & $\Delta$ Agricultura & 1 & + & $-0{,}0111$ & $0{,}0213$ & $0{,}603$ & $0{,}00020$ & 6.308 \\
Aptidão edafoclim. (exógena) & $\Delta$ Pastagem & 0 & - & $+0{,}0018$ & $0{,}0175$ & $0{,}920$ & $0{,}00000$ & 6.474 \\
Aptidão edafoclim. (exógena) & $\Delta$ Pastagem & 1 & - & $-0{,}0026$ & $0{,}0123$ & $0{,}832$ & $0{,}00001$ & 6.308 \\
\bottomrule
\end{tabular}
\fontefig{elaboração própria.}
\notafig{\emph{shifter}: variação padronizada do índice de taxa de câmbio efetiva real. ``Def.'' é a defasagem em anos do \emph{shifter}; ``Sinal'' é a direção prevista antes da estimação. Efeitos fixos de unidade e de ano; erros-padrão agrupados nas duas dimensões em todas as linhas; 166 unidades. O $n$ \textbf{não é o mesmo em toda a grade}, e o que o move é a \textbf{defasagem}, não a cobertura das exposições: nenhuma delas perde célula, e defasar o \emph{shifter} em um ano custa um ano de painel em cada unidade --- as duas linhas de cada exposição diferem, por isso, exatamente pelo número de unidades. É reportado linha a linha mesmo assim. O $p$ desta tabela é o do erro-padrão agrupado, que a Seção~\ref{sec:met-instrumental} mostra ser otimista neste desenho, porque trata cada ano como realização independente do choque quando as realizações efetivas são cerca de 38. A régua de permutação não foi computada para estas linhas: ela existe para a especificação confirmatória do rebanho, na Tabela~\ref{tab:horserace}, cujas regressões são outras. Nas dez linhas em que as duas foram computadas lado a lado, o $p$ agrupado saiu \emph{menor} que o de permutação em oito --- e em duas, maior. É regularidade observada, e não garantia matemática de que o agrupado limite o outro por baixo; chamá-lo de ``piso da incerteza'' seria dizer mais do que se mediu, e o $p$-valor não é, de todo modo, uma medida de incerteza. Nenhum $p$ desta tabela é lido como significância no corpo do texto.}
\end{table}
...
\footnotesize
\begin{tabular}{p{3.7cm}p{2.4cm}cccccr}
\toprule
\textbf{Especificação} & \textbf{Regressor} & \textbf{$\hat{\beta}$} & \textbf{EP} & \textbf{$p_{ent}$} & \textbf{$p_{ent+ano}$} & \textbf{$R^2_w$} & \textbf{$n$} \\
\midrule
B1  fluxo $\sim$ estoque\_def (disponibilidade) & estoque defasado (z) & $+2{,}756$ & $0{,}472$ & $<0{,}001$ & $<0{,}001$ & $0{,}434$ & 6.396 \\
B1q fluxo $\sim$ estoque + estoque$^2$ (não-linear) & estoque defasado (z) & $+2{,}686$ & $0{,}476$ & $<0{,}001$ & $<0{,}001$ & $0{,}434$ & 6.396 \\
B1q fluxo $\sim$ estoque + estoque$^2$ (não-linear) & estoque defasado$^2$ (z) & $+0{,}045$ & $0{,}451$ & $0{,}928$ & $0{,}920$ & $0{,}434$ & 6.396 \\
B2a hazard $\sim$ estoque\_def & estoque defasado (z) & $-0{,}319$ & $0{,}189$ & $0{,}002$ & $0{,}092$ & $-0{,}009$ & 6.379 \\
B2b hazard $\sim$ esgotamento\_def & esgotamento defasado (z) & $-0{,}015$ & $0{,}022$ & $0{,}317$ & $0{,}481$ & $-0{,}000$ & 6.379 \\
B3  fluxo $\sim$ estoque + demanda (sem ano FE) & estoque defasado (z) & $+2{,}763$ & $0{,}455$ & $<0{,}001$ & $<0{,}001$ & $0{,}436$ & 6.396 \\
B3  fluxo $\sim$ estoque + demanda (sem ano FE) & $\Delta$ câmbio real (z) & $+0{,}022$ & $0{,}017$ & $0{,}003$ & $0{,}179$ & $0{,}436$ & 6.396 \\
B3  fluxo $\sim$ estoque + demanda (sem ano FE) & $\Delta$ preço da soja (z) & $-0{,}030$ & $0{,}021$ & $<0{,}001$ & $0{,}150$ & $0{,}436$ & 6.396 \\
B3  fluxo $\sim$ estoque + demanda (sem ano FE) & $\Delta$ crédito rural (z) & $+0{,}001$ & $0{,}017$ & $0{,}828$ & $0{,}950$ & $0{,}436$ & 6.396 \\
\bottomrule
\end{tabular}
\fontefig{elaboração própria.}
\notafig{desfecho: fluxo anual de conversão, exceto nas linhas \texttt{B2a} e \texttt{B2b}, cujo desfecho é a \emph{taxa}. Regressores em \emph{escore-z}. Efeitos fixos de unidade e de ano em todas as linhas \textbf{menos} as do \texttt{B3}, que dispensa o de ano de propósito: os sinais de demanda que ele testa (câmbio, preço, crédito) são nacionais e um efeito fixo de ano os absorveria por inteiro, deixando o coeficiente sem identificação. Dispensar o efeito fixo de ano \textbf{não} impede o agrupamento por ano, que é escolha independente dele: as nove linhas trazem as duas réguas de erro-padrão, e a que decide é a de duas dimensões, como na Tabela~\ref{tab:deplecao}. O erro-padrão da coluna EP é o dela. Registre-se que até 21/ago/2026 esta tabela publicava o \texttt{B3} só na régua de unidade e a descrevia como imposição do desenho: era acoplamento de código, e recaía justamente onde mais custa, porque regressor constante dentro do ano tem o erro-padrão subestimado pelo agrupamento por unidade. Corrigido, o estoque segue com $p<0{,}001$ e os três sinais de demanda deixam de cruzar 5\%. Nenhum dos três é lido como significância --- e a Seção~\ref{sec:met-instrumental} não o autorizaria nem sob a régua de duas dimensões, que trata cada ano como realização independente de um choque nacional. O painel efetivo destas linhas tem 164 das 166 unidades: duas AMCs do Sul não registram formação savânica nem campo nativo em ano algum da série, e nelas o estoque convertível é \emph{ausente}, e não zero. A linha \texttt{B2b} é a especificação que a decisão D29 superou; ver a Tabela~\ref{tab:deplecao}.}
\end{table}

\begin{table}[!ht]
\centering
\caption[Grade de tratamentos da variável de esgotamento]{Grade completa de tratamentos da variável de esgotamento (decisão D29).}
\label{tab:deplecao}
\scriptsize
\begin{tabular}{p{3.6cm}llcccccr}
\toprule
\textbf{Tratamento do esgotamento} & \textbf{Amostra} & \textbf{Peso} & \textbf{$\hat{\beta}_z$} & \textbf{p.p./0,1} & \textbf{$p_{ent}$} & \textbf{$p_{ent+ano}$} & \textbf{$R^2_w$} & \textbf{$n$} \\
\midrule
