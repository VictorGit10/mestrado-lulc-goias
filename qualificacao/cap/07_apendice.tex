...
\begin{table}[!ht]
\centering
\caption[Ordens de integração das séries regionais]{Testes de raiz unitária nas séries regionais, em nível e em primeira diferença.}
...
\notafig{as hipóteses nulas dos dois testes são \textbf{opostas}: o ADF tem por nula a presença de raiz unitária, de modo que $p$ baixo indica série estacionária; o KPSS tem por nula a estacionariedade, de modo que $p$ baixo indica o contrário. O veredito da última coluna é o do ADF. O KPSS rejeita em todas, inclusive onde o ADF não rejeita, e essa discordância é a razão de a classificação ser \emph{a resposta do teste} nesta amostra, e não propriedade estabelecida do processo: com 39 observações e duas quebras estimadas nessas mesmas séries, nenhum dos dois é decisivo sozinho. O que a tabela estabelece com segurança é o \emph{descasamento} entre as duas séries, que é o que invalida o teste clássico.}
\end{table}
...
\multicolumn{8}{l}{\textit{Sul$\rightarrow$Norte: $\Delta$Agric\_Sul $\rightarrow$ $\Delta$Pasto\_Norte}} \\
 & 1 & $0{,}971$ & $0{,}959$ & $0{,}252$ & $+0{,}0022$ & $0{,}959$ & 38 \\
 & 2 & $0{,}760$ & $0{,}703$ & $0{,}246$ & $-0{,}0257$ & $0{,}669$ & 37 \\
...
\multicolumn{8}{l}{\textit{REVERSO:   $\Delta$Pasto\_Norte $\rightarrow$ $\Delta$Agric\_Sul}} \\
 ...
 & 2 & $0{,}075$ & $0{,}005$ & $0{,}748$ & $+0{,}3494$ & $0{,}339$ & 37 \\
...
\label{tab:sarsem}
\scriptsize
\begin{tabular}{lcrcccccccll}
\toprule
\textbf{Modelo} & \textbf{$W$} & \textbf{$n$} & \textbf{$\hat{\beta}_{MQ}$} & \textbf{EP} & \textbf{$p$} & \textbf{$\hat{\beta}_{SAR}$} & \textbf{$\hat{\beta}_{SEM}$} & \textbf{$\hat{\rho}$} & \textbf{$\hat{\lambda}$} & \textbf{Forma} & \textbf{Sobrev.} \\
\midrule
M1 & \emph{queen} & 3.154 & $-0{,}0047$ & $0{,}0005$ & $<0{,}001$ & $-0{,}0043$ & $-0{,}0046$ & $0{,}353$ & $0{,}368$ & SEM & sim \\
M2 & \emph{queen} & 1.328 & $-0{,}0040$ & $0{,}0008$ & $<0{,}001$ & $-0{,}0035$ & $-0{,}0034$ & $0{,}398$ & $0{,}401$ & SAR & sim \\
M3 & \emph{queen} & 6.474 & $-0{,}5458$ & $0{,}0774$ & $<0{,}001$ & $-0{,}4774$ & $-0{,}5356$ & $0{,}391$ & $0{,}414$ & SEM & sim \\
M3 & 8 viz. & 6.474 & $-0{,}5458$ & $0{,}0774$ & $<0{,}001$ & $-0{,}4813$ & $-0{,}5491$ & $0{,}532$ & $0{,}558$ & SEM & sim \\
\bottomrule
\end{tabular}
\fontefig{elaboração própria.}
\notafig{todas as especificações correm sobre as 166 unidades, em primeira diferença e com efeitos fixos de unidade e de ano; $n$ é o total de células após exclusão de ausentes, e varia porque as fontes dos regressores cobrem janelas diferentes (o SICOR do M2 começa em 2013). $W$ identifica a matriz de pesos: \emph{queen} é a de contiguidade, ``8 viz.'' a dos oito vizinhos mais próximos --- o M3 é estimado com as duas, para medir quanto a escolha de $W$ move o resultado. O erro-padrão e o $p$ são os da estimação por mínimos quadrados; $\hat{\rho}$ é o parâmetro de defasagem espacial do SAR e $\hat{\lambda}$ o de dependência do erro no SEM. ``Forma'' é a preferida pelos testes do multiplicador de Lagrange em versão robusta, nomeada pela forma que ela indica (SAR para defasagem, SEM para erro). ``Sobrev.'' indica se o sinal e a significância do coeficiente de interesse resistem à modelagem da dependência: nas quatro linhas o coeficiente atenua-se e nenhuma troca de sinal.}
\end{table}
