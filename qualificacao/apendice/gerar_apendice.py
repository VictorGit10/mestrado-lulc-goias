...
com \(\sigma\) populacional. Os coeficientes de interação leem-se, portanto,
...
O primeiro bloco, na Tabela~\ref{tab:ifdm-gradiente}, é transversal e mede se o
índice se ordena pela latitude --- em nível e em variação --- com e sem controle
de longitude, que separa o gradiente sul-norte do gradiente leste-oeste. O
segundo, na Tabela~\ref{tab:ifdm-painel}, é um painel de efeitos fixos
