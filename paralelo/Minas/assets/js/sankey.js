 ...
 * Adaptado para MG. Namespace MG40. Dados em sankey_data_mg.json.
 */
(function (root) {
  "use strict";
  ...
  async function carregarERenderizar() {
    ...
    try {
      await loadVendors();
      const resp = await fetch("assets/data/sankey_data_mg.json");
      if (!resp.ok) throw new Error("sankey_data_mg.json: " + resp.status);
  ...
  root.MG40 = root.MG40 || {};
  root.MG40.sankey = { init, renderizar };
  init();
