 ...
 * Exposto como window.MG40 (namespace global; mantem vanilla sem ES modules).
 * Adaptado de Visualizacao para Minas Gerais.
 * Sem dados de fogo — camada de fogo removida.
 */
...
(function (root) {
  ...
  // Anos-marco (politicos) — TODO: definir marcos especificos de MG.
  ...
  // Fogo removido (sem dados de fogo para MG).
