...
### 4. Régua-espelho: a deriva do Mosaico e a divergência raster×SIDRA no Ato III

Propaga a robustez oficial do #32 (régua-espelho, #28D/D25) para o nível desagregado. Aqui a deriva fica **mais nítida que em qualquer outro pipeline**, porque a fonte está aberta: o rótulo "Soja" do raster perde a soja recém-convertida para o "Mosaico", enquanto a SIDRA a conta. ΔNorte no **Ato III (2020→24)**, com IC95% (D19):
...
4. **A régua-espelho da deriva (#28D) é robustez, não ressalva**: sob `agric∪mosaico` e SIDRA (imune) a agricultura segue subindo no Ato III; o "congelamento" do rótulo cru é artefato. O núcleo (agricultura ao sul da fronteira) sobrevive nas três réguas.
