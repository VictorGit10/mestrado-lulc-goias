...
| Formação | ΔN médio | ΔN mediano | leitura |
|---|---:|---:|---|
| Floresta nativa | +8,7 km | +13,6 | **presa** (achata após o Ato I) — é o que o lump chama de "muralha" |
| Formação savânica (Cerrado *s.s.*) | +12,4 km | +24,6 | recuo **modesto** — reserva do norte, ainda pouco alcançada |
| Campo nativo | +34,8 km | +98,7 | recuo **forte** ao norte (magnitude instável) |

O lump "+7,6 km" é a **média de uma floresta presa com um campo nativo que fugiu ao norte**. O campo nativo — grama aberta, a formação **mais barata de converter** (sem desmate) — foi consumido primeiro no Sul e cedo (por ato: **I:+30**, depois ~parado), então seu centro de massa disparou ao norte. A floresta nativa fica **presa** (consistente com mata ciliar/ripária protegida seguindo rios). A savânica é a **reserva setentrional** ainda pouco tocada. Visualmente (`desagregado_vegetacao.png`), por volta de **2021 o centroide do pasto ultrapassa em latitude a floresta e o campo nativo** — a fronteira **alcançou** a vegetação convertível que ainda restava.

Isso **fortalece e torna mais honesta** a narrativa: as formações naturais **convertíveis** recuaram ao norte junto com a fronteira; só a floresta fisicamente protegida ficou parada. O lump escondia isso.

> Cautela: o campo nativo tem **magnitude instável** (médio +35 vs mediano +99; nº de AMCs com campo cai de 158→142 — algumas zeram). A **direção** (forte recuo ao norte) é robusta; o **valor** não. Reportar como "recuou muito ao norte", não cravar km.

### 3. Controles: a marcha ao norte é específica da fronteira

| Variável | ΔN médio | leitura |
|---|---:|---|
| **Área urbana** | **−8,4 km** (med +2,9) | **parada** — placebo limpo |
| Leite (produção) | +29,9 km | move **muito menos** que o boi, e fica ao sul |
| Rebanho bovino (total) | +66,9 km | (referência) |
| Pastagem | +77,6 km | (referência) |

- **Área urbana é o controle negativo limpo**: o centro de massa fica **horizontal** por 40 anos (lat −16,43 → −16,51, no eixo Goiânia–Anápolis). A urbanização **não** seguiu a fronteira ao norte → **a marcha ao norte não é deriva genérica de centroide**, é específica da fronteira agropecuária.
