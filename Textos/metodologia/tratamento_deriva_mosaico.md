...
| **#34** deslocamento (lead-lag + SLX) | `lulc_agricultura_ha` e `agricultura_delta_mha` | **exposto — 2 blocos robustos, 1 rebaixado** | auditado só em **28/jul/2026** (a varredura de 23–25/jul não o alcançou). Temporal: **0/24** células significativas nas 3 réguas × 2 janelas. Substituição local: **robusta** e maior sob a união (−0,52→−1,14). Spillover direcional: **sinal robusto (12/12 θ<0), significância NÃO** (p<0,05 em 1/12, na régua exposta) — não citar o p=0,02 como robusto |
