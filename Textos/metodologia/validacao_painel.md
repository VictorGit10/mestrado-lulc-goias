...
- **Composição etária bovina** — não há desagregação etária municipal no SIDRA (PPM/Censo Agro); por isso a lotação é expressa em cabeças/ha (dado medido), não em Unidade Animal, que exigiria um fator 0,7 estacionário não comparável ao longo de 1985–2024.
