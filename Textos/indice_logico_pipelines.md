...
| **Extensão** | **#51** `crescimento_sem_desenvolvimento.py` | Põe um **número** no "crescimento sem desenvolvimento" do #50 (IFDM 2013–2023): a fronteira **Norte cresce ~3× mais em área** mas ganha desenvolvimento **igual** ao Sul e fica **−0,08 abaixo** (robusto); no município o crescimento é **desacoplado** do desenvolvimento (área: r²within≈0). Reabre o fio descartado por falta de dado |
