...
| **Extensão** | **#47** `custo_carbono_marcha.py` | O **custo** da marcha: ~**973 Mt CO₂e** de **estoque removido**; a **emissão líquida** é de **833 Mt**, descontado o estoque do uso que entra no lugar (**D31**). Densidades do **4º Inventário Nacional**, com valor de floresta específico de Goiás (**D30**, 20/ago/2026 — substitui a D18). A **savânica domina o estoque removido** (573 × 340 Mt): ela perdeu 2,6× mais área, e isso mais que compensa valer menos por hectare. O centróide da perda marcha +91 km ao norte — amarra com o #39 |
