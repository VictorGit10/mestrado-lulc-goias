...
- **Seu resultado:** no #34, `θ = −0,16` — **oposto** ao previsto, e negativo em **12/12** especificações sob o bracket D26 com 8 vizinhos (com 4 ou 12 vizinhos, algumas do rebanho viram positivas, mas nenhuma significativa) (a significância, essa, só aparece na régua exposta). Vizinhos ao sul **co-expandem**
