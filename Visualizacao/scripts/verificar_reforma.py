...
def main():
    ...
    with sync_playwright() as p:
        ...
        if fecho.get("decisoes") != 31:
            erros.append(f"{fecho.get('decisoes')} cards de decisao (esperava 31 = D1-D31, com a D18 superada)")
        if not fecho.get("decisoesColapsadas"):
            erros.append("as 31 decisoes deveriam comecar colapsadas (sao referencia)")
